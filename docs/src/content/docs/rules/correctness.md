...
**Learn more**: [Invalid Keyword](https://octofhir.github.io/maki/rules/correctness/invalid-keyword)
...
**Learn more**: [Malformed Alias](https://octofhir.github.io/maki/rules/correctness/malformed-alias)
...
**Learn more**: [Invalid Caret Path](https://octofhir.github.io/maki/rules/correctness/invalid-caret-path)
...
**Learn more**: [Missing Profile ID](https://octofhir.github.io/maki/rules/correctness/missing-profile-id)
...
**Learn more**: [Invalid Identifier](https://octofhir.github.io/maki/rules/correctness/invalid-identifier)
...
**Learn more**: [Invalid Slicing](https://octofhir.github.io/maki/rules/correctness/invalid-slicing)
...
**Learn more**: [Duplicate Canonical URL](https://octofhir.github.io/maki/rules/correctness/duplicate-canonical-url)
...
**Learn more**: [Duplicate Identifier](https://octofhir.github.io/maki/rules/correctness/duplicate-identifier)
...
**Learn more**: [Invalid Constraint](https://octofhir.github.io/maki/rules/correctness/invalid-constraint)
...
**Learn more**: [Missing Parent Profile](https://octofhir.github.io/maki/rules/correctness/missing-parent-profile)
...
**Learn more**: [Invalid Status](https://octofhir.github.io/maki/rules/correctness/invalid-status)
...
**Learn more**: [Profile Assignment Present](https://octofhir.github.io/maki/rules/correctness/profile-assignment-present)
...
**Learn more**: [Extension Context Missing](https://octofhir.github.io/maki/rules/correctness/extension-context-missing)
