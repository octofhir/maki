...
hero:
  ...
  actions:
    - text: Get Started
      link: /fsh-lint-rs/getting-started/introduction/
      icon: right-arrow
      variant: primary
    - text: View on GitHub
      link: https://github.com/octofhir/fsh-lint-rs
      icon: external
---
...
<div style="margin-top: 2rem;">
  <a href="/fsh-lint-rs/getting-started/introduction/" class="sl-link-button">Learn More →</a>
</div>
