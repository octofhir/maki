...
hero:
  ...
  actions:
    - text: Get Started
      link: /maki-rs/getting-started/introduction/
      icon: right-arrow
      variant: primary
    - text: View on GitHub
      link: https://github.com/octofhir/maki-rs
      icon: external
---
...
<div style="margin-top: 2rem;">
  <a href="/maki-rs/getting-started/introduction/" class="sl-link-button">Learn More →</a>
</div>
