# Getting Started with GritQL Autofixes
...
1. **Read the full guide**: [GritQL Autofixes](./gritql-autofixes.md)
2. **API Reference**: [Complete API Docs](./gritql-api-reference.md)
3. **Pattern Examples**: [GritQL Patterns](./gritql-patterns.md)
