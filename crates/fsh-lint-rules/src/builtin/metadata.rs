...
use fsh_lint_core::cst::ast::{AstNode, CodeSystem, Document, Extension, Profile, ValueSet};
...
fn create_missing_metadata_diagnostic(
    ...
    resource_name: &str,
    field_name: &str,
    node: &fsh_lint_core::cst::FshSyntaxNode,
    model: &SemanticModel,
    message: &str,
) -> Diagnostic {
    ...
    let insert_location = fsh_lint_core::diagnostics::Location {
    ...
    .with_suggestion(fsh_lint_core::CodeSuggestion::safe(
