...
impl FshLintError {
    ...
    pub fn kind(&self) -> ErrorKind {
        match self {
            FshLintError::ParseError { .. } => ErrorKind::Parse,
            FshLintError::ConfigError { .. } => ErrorKind::Config,
            FshLintError::RuleError { .. } => ErrorKind::Rule,
            FshLintError::IoError { .. } => ErrorKind::Io,
            FshLintError::SemanticError { .. } => ErrorKind::Semantic,
            FshLintError::CacheError { .. } => ErrorKind::Cache,
...
impl From<std::io::Error> for FshLintError {
