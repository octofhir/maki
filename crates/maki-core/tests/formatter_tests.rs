...
*name 1..1"#;
    ...
    let _added = diff.changes_of_type(maki_core::DiffChangeType::Added);
    let _removed = diff.changes_of_type(maki_core::DiffChangeType::Removed);
    let _modified = diff.changes_of_type(maki_core::DiffChangeType::Modified);
    let _unchanged = diff.changes_of_type(maki_core::DiffChangeType::Unchanged);
